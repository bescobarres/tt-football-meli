package com.bescobarres.football.domain.dto.input;
...
public class TrainingInputDto {
    ...
    @Min(value = 0, message = "El campo power debe ser un valor mayor o igual a 0")
    @Max(value = 100, message = "El campo power debe ser un valor entre 0 y 100")
    @NotNull(message = "El campo power no debe ser NULL ")
    private double power;

    @Min(value = 0, message = "El campo distance debe ser un valor mayor o igual a 0")
    @NotNull(message = "El campo distance no debe ser NULL")
    private Double distance;

    @Min(value = 0, message = "El campo time debe ser un valor mayor o igual a 0")
    @NotNull(message = "El campo time no debe ser NULL")
    private Long time;

    @Min(value = 0, message = "El campo passes debe ser un valor mayor o igual a 0")
